...
\cvitem{2017--2020}
        {Transient absorption images and SEM images colocalization 
...
\cvitem{2008--2010}
        ...
        of single II--VI crystals 
        by chemical vapor transport (CVT) through Chernov bulk diffusion model}
%------------------------------------------
%  Experiences
%------------------------------------------
\section{Experiences}
...
\cvitem{2013--2020}
        {Rewarded NCTU Scholarship and tuition waiver 
...
\section{Technical Skills}
    ...
    \cvlistdoubleitem{\small \raggedright Image Processing in ImageJ, MATLAB, Napari}
                    {\small \raggedright XRD data analysis with FullProf Suite}
    ...
    \cvlistdoubleitem{\small \raggedright Calibration and maintenance of multi-zone
